...
export const mockProcesses: Process[] = [
  ...
  {
    id: "7",
    nome: "Gestão de diárias e passagens",
    unidade: "Pró-Reitoria de Administração",
    unidadeSigla: "PROAD",
    setor: "Financeiro",
    ...
    etapas: [
      {
        id: 1,
        titulo: "Identificação de Riscos",
        descricao: "Mapeamento de riscos no processo de concessão de diárias e passagens",
        riscos: [
          {
            id: "r8",
            nome: "Pagamento indevido de diárias",
            faseProcesso: "Execução",
            tipoRisco: "AMEAÇA",
            descricao: "Possibilidade de pagamento incorreto ou sem comprovação adequada",
            probabilidade: "Média",
            impacto: "Alto",
            nivelRisco: "Alto",
          },
        ],
        observacoes: "Processo aguardando início da revisão anual obrigatória",
      },
      {
        id: 2,
        titulo: "Avaliação de Riscos e Controles",
        descricao: "Avaliação dos controles existentes",
        controles: [
          "Validação prévia da chefia imediata",
          "Checklist documental obrigatório",
          "Conferência financeira mensal",
        ],
        observacoes: "Controles existentes precisam ser reavaliados no novo ciclo",
      },
      {
        id: 3,
        titulo: "Resposta aos Riscos",
        descricao: "Definição de respostas aos riscos",
        respostas: [
          "Mitigar: reforçar conferência documental",
          "Mitigar: automatizar validações no sistema",
        ],
        observacoes: "",
      },
      {
        id: 4,
        titulo: "Atividades de Controle",
        descricao: "Atividades de monitoramento e prevenção",
        atividades: [
          "Auditoria trimestral de concessões",
      ...
      },
      {
        id: 5,
        titulo: "Ocorrências de Risco",
        descricao: "Registro de ocorrências anteriores",
        ocorrencias: [
          "12/03/2024 - Divergência identificada em prestação de contas",
        ],
        observacoes: "Ocorrência resolvida e registrada",
      },
    ],
    historico: [
      {
      ...
      },
      {
        ...
        hora: "10:00",
        usuario: "Juliana Mendes",
        observacao: "Primeira revisão enviada para SECGOV",
      },
      {
        id: "h7-3",
        tipo: "revisado",
        ...
        hora: "14:20",
        usuario: "Equipe SECGOV",
        observacao: "Revisão aprovada sem ressalvas",
      },
      {
        id: "h7-4",
        tipo: "concluido",
        ...
        hora: "17:00",
        usuario: "Equipe SECGOV",
        observacao: "Ciclo encerrado com aprovação",
      },
      {
        id: "h7-5",
        tipo: "pendente_revisao_anual",
        data: "28/04/2025",
        hora: "08:00",
        usuario: "Sistema",
        observacao: "Processo entrou automaticamente em revisão anual obrigatória",
      },
    ],
  }
