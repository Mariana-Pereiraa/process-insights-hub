      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <main className="flex-1 p-6 overflow-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-8">
            <div className="bg-status-review-bg/50 border border-status-review/20 rounded-2xl p-6 flex items-center gap-5 border-slate-400 bg-slate-900">
              ...
              <div>
                ...
                <p className="text-3xl font-bold text-status-review text-slate-800">{totalRevisao}</p>
              </div>
            </div>
